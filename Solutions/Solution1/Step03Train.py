...
allImagesNP = np.load("F:/Dataset/Create/Unet-Animals-train-images.npy")
maskImagesNP = np.load("F:/Dataset/Create/Unet-Animals-train-mask.npy")
...
test2 = to_categorical(test, num_classes=numOfCategories) # 3
...
best_model_file="F:/Dataset/Create/Animals-Unet.keras"
